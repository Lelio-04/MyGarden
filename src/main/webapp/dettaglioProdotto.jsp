...
<header>
    ...
    <nav class="main-nav">
        <ul class="nav-links">
            ...
            <li><a href="<%=request.getContextPath()%>/product" id="signed"><%= (Boolean.TRUE.equals(session.getAttribute("isAdmin"))) ? "Gestione Catalogo" : "Catalogo" %></a></li>
            <li><a href="carrello.jsp"><%= (Boolean.TRUE.equals(session.getAttribute("isAdmin"))) ? "Gestione Ordini" : "Carrello" %></a></li>
            <% if (username != null) { %>
